...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        {/* Título Otimizado */}
        <title>About Andrad PBS Solution - Construction and Renovation in Seattle Area</title>
        
        {/* Descrição Otimizada */}
        <meta 
          name="description" 
          content="Learn about Andrad PBS Solution's history and commitment to quality construction, renovation, and maintenance services in Seattle, Kirkland, Bellevue, Redmond, and surrounding King and Snohomish County areas." 
        />
        
        {/* Palavras-chave Otimizadas */}
        <meta 
          name="keywords" 
          content="about construction company seattle, andrad pbs solution history, renovation contractors kirkland, maintenance services bellevue, construction company redmond, construction bothell, general contractors seattle area"
        />
        
        {/* Canonical (Se esta for a página About) */}
        <link rel="canonical" href="https://www.andradpbsolution.com/#about-page" /> 
      </Head>
